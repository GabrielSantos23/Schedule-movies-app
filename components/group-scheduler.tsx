...
function MovieCard({
  ...
  return (
    <div className="group flex-shrink-0 w-[160px] md:w-[180px]">
      <Link href={`/movie/${schedule.movie_id}`}>
        <div className="relative aspect-[2/3] rounded-xl overflow-hidden bg-muted/50 shadow-lg transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-primary/20 group-hover:-translate-y-2 cursor-pointer">
